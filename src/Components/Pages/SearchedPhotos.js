...
const SearchedPhotos = (props) => {
    ...
    return (
        <>
            {!isNotSearchQueryValid && <div className="photos">
            ...
            {isNotSearchQueryValid && <div style={{ height: '80vh', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>

                <h2> <BiErrorCircle /> Please Enter Valid Input</h2>
            </div>}
        </>
    )
}
